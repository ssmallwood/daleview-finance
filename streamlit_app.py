...
# Check if this is the first time viewing the page in this session
...
# Optional: Add a smaller permanent reminder in the sidebar
st.sidebar.markdown("---")
...
# Add this after password check but before main content in Home.py
# Just after your st.title() call
